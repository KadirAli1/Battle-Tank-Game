...
namespace Battle_Tank
{
    ...
    {
        public Scene6(int Width, int Height)
            : base(6, 5, 90, 90, Width, Height, Color.FromArgb(232, 240, 240))
        {
            ...
            // FIRST COLUMN
            // HORIZONTAL
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 0 * ColumnWidth, 1 * RowHeight + Scene.TOP, ColumnWidth, 6), Resources.Scene1_HorizontalWall));
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 0 * ColumnWidth, 4 * RowHeight + Scene.TOP, ColumnWidth, 6), Resources.Scene1_HorizontalWall));
            // VERTICAL
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * ColumnWidth, 4 * RowHeight + Scene.TOP, 6, RowHeight), Resources.Scene1_VerticalWall));

            // SECOND COLUMN
            // HORIZONTAL
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * ColumnWidth, 5 * RowHeight + Scene.TOP, ColumnWidth, 6), Resources.Scene1_HorizontalWall));
            // VERTICAL
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 2 * ColumnWidth, 2 * RowHeight + Scene.TOP, 6, RowHeight), Resources.Scene1_VerticalWall));
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 2 * ColumnWidth, 4 * RowHeight + Scene.TOP, 6, RowHeight), Resources.Scene1_VerticalWall));

            // THIRD COLUMN
            // HORIZONTAL
            
            // VERTICAL
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 3 * ColumnWidth, 4 * RowHeight + Scene.TOP, 6, RowHeight), Resources.Scene1_VerticalWall));
            ...
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 4 * ColumnWidth, 5 * RowHeight + Scene.TOP, ColumnWidth, 6), Resources.Scene1_HorizontalWall));
            // VERTICAL
            ...
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * 270, Scene.TOP - 17, 180, 17), Resources.Scene1_TopDecor));
            ...
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * 270, Scene.TOP + Rows * RowHeight + 6, 180, 17), Resources.Scene1_BottomDecor));
