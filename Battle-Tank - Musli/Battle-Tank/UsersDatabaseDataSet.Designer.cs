...
namespace Battle_Tank {
    ...
    public partial class UsersDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(string UserName, string UserPassword, int Points) {
...
namespace Battle_Tank.UsersDatabaseDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([UserName] = @Origina" +
                "l_UserName) AND ([UserPassword] = @Original_UserPassword) AND ([Points] = @Origi" +
                "nal_Points))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([UserName], [UserPassword], [Points]) VALUES (@UserNam" +
                "e, @UserPassword, @Points);\r\nSELECT Id, UserName, UserPassword, Points FROM User" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserName] = @UserName, [UserPassword] = @UserPassword, [Points] = @Points WHERE (([Id] = @Original_Id) AND ([UserName] = @Original_UserName) AND ([UserPassword] = @Original_UserPassword) AND ([Points] = @Original_Points));
SELECT Id, UserName, UserPassword, Points FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Battle_Tank.Properties.Settings.Default.UsersDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserName, UserPassword, Points FROM dbo.Users";
        ...
        public virtual int Fill(UsersDatabaseDataSet.UsersDataTable dataTable) {
        ...
        public virtual UsersDatabaseDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsersDatabaseDataSet.UsersDataTable dataTable = new UsersDatabaseDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsersDatabaseDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_UserName, string Original_UserPassword, int Original_Points) {
        ...
        public virtual int Insert(string UserName, string UserPassword, int Points) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string UserPassword, int Points, int Original_Id, string Original_UserName, string Original_UserPassword, int Original_Points, int Id) {
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string UserPassword, int Points, int Original_Id, string Original_UserName, string Original_UserPassword, int Original_Points) {
            return this.Update(UserName, UserPassword, Points, Original_Id, Original_UserName, Original_UserPassword, Original_Points, Original_Id);
        }
    }
