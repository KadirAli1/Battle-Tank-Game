...
namespace Battle_Tank
{
    public class Scene2 : Scene
    {
            ...
            : base(5, 6, 90, 90, Width, Height, Color.FromArgb(232, 240, 240))
        {
            ...
            for (int i = 0; i < 6; ++i)
            {
                DecorWalls.Add(new Wall(new Rectangle(i * ColumnWidth + Scene.LEFT, Rows * RowHeight + Scene.TOP + 6, ColumnWidth, 12), Resources.Scene2_OuterWallHorizontal));
            }
            ...
            for (int i = 0; i < 5; ++i)
            {
                DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + Columns * ColumnWidth + 6, i * RowHeight + Scene.TOP, 12, RowHeight), Resources.Scene2_OuterWallVertical));
            }
