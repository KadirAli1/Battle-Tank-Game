...
namespace Battle_Tank
{
    public class Scene7 : Scene
    {
            ...
            : base(4, 6, 95, 95, Width, Height, Color.FromArgb(232, 240, 240))
        {
            ...
            for (int i = 0; i < 6; ++i)
            {
                Walls.Add(new Wall(new Rectangle(i * ColumnWidth + Scene.LEFT, Rows * RowHeight + Scene.TOP + 8, ColumnWidth, 16), Resources.Scene7_OuterWallBottom));
            }
            ...
            for (int i = 0; i < 4; ++i)
            {
                Walls.Add(new Wall(new Rectangle(Scene.LEFT + Columns * ColumnWidth + 8, i * RowHeight + Scene.TOP, 16, RowHeight), Resources.Scene7_OuterWallRight));
            }
