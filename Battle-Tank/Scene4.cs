...
namespace Battle_Tank
{
    public class Scene4 : Scene
    {
            ...
            : base(5, 11, 90, 90, Width, Height, Color.FromArgb(232, 240, 240))
        {
            ...
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + 3 * 270, Scene.TOP - 17, 180, 17), Resources.Scene1_TopDecor));
            ...
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + Columns * ColumnWidth + 6, Scene.TOP + 1 * 270 + offset, 17, 180), Resources.Scene1_RightDecor));
            ...
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT + 3 * 270, Scene.TOP + Rows * RowHeight + 6, 180, 17), Resources.Scene1_BottomDecor));

            // LEFT
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT - 17, Scene.TOP + offset, 17, 270), Resources.Scene1_LeftDecor));
            DecorWalls.Add(new Wall(new Rectangle(Scene.LEFT - 17, Scene.TOP + 1 * 270 + offset, 17, 180), Resources.Scene1_LeftDecor));
        }
