...
namespace Battle_Tank
{
    public class Scene6 : Scene
    {
            ...
            : base(6, 5, 90, 90, Width, Height, Color.FromArgb(232, 240, 240))
        {
            ...
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * 270, Scene.TOP - 17, 180, 17), Resources.Scene1_TopDecor));
            ...
            Walls.Add(new Wall(new Rectangle(Scene.LEFT + 1 * 270, Scene.TOP + Rows * RowHeight + 6, 180, 17), Resources.Scene1_BottomDecor));
